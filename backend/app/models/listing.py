...
class Listing(Base):
    ...
    accessible_bathroom = Column(Boolean, default=False, nullable=False)
    elevator_access = Column(Boolean, default=False, nullable=False)
    braille_signage = Column(Boolean, default=False, nullable=False)
    hearing_loop = Column(Boolean, default=False, nullable=False)
    visual_alerts = Column(Boolean, default=False, nullable=False)
